...
def main() -> int:
    ...
    parser.add_argument("--request", required=True, help='Business request, such as "Analyze sales order SO-1005"')
    ...
    parser.add_argument("--use-llm", action="store_true", help="Use configured planner provider if supplied by code.")
